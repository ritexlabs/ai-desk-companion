---
name: dhanhq
description: "DhanHQ Indian market trading skill. Use when generating code that interacts with Dhan APIs: placing orders, fetching holdings/positions, option chains, historical/live market data, margin checks, fund limits, eDIS flows. Covers SDK constants, method signatures, safety rules, rate limits, error codes, and integration with ScanX for fundamentals."
---
