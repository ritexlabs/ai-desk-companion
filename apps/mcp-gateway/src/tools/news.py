    ...
    async def call_tool(self, tool_name: str, arguments: dict) -> Any:
        ...
        if not api_key:
            return (
                ...
                'Add your GNews API key as NEWS_API_KEY in the gateway .env file.'
            )

        country        = settings.news_default_country.lower().strip()
        ...
        try:
            ...
            if not articles:
                ...
                return f'No news found {subject}. Try adjusting your search or NEWS_DEFAULT_COUNTRY in gateway .env.'
